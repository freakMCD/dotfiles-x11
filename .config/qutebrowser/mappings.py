...
config.set('hints.selectors', {'videos': ['a[data-a-target*="preview-card-image"]', 'a[class*="side-nav-card"]']}, pattern='*://*.twitch.tv/*')
...
bind = {
    ...
    "gt": "open https://www.twitch.tv/directory/following/videos",
    "gD": "open -t https://discord.com/channels/@me",
    "gW": "open -t https://web.whatsapp.com",
    "gT": "open -t https://www.twitch.tv/directory/following/videos",
